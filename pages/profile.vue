  ...
  <div class="container mx-auto px-4 py-8 min-h-screen">
    <div class="max-w-4xl mx-auto">
      <div class="text-center mb-8">
        <h1 class="text-4xl font-bold text-base-content mb-4">Profile</h1>
        <p class="text-base-content/70">Manage your user profile and account information</p>
      </div>
      ...
      <div class="bg-base-100 rounded-lg p-8 text-center">
        ...
        <h2 class="text-2xl font-semibold text-base-content mb-2">{{ user?.name || 'User' }}</h2>
        <p class="text-base-content/70 mb-6">{{ user?.email || 'user@example.com' }}</p>
        ...
        <p class="text-base-content/70 mb-6">Profile management features are currently under development.</p>
